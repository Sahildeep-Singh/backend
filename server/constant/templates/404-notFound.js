...
<html lang="en">
  <head>
    ...
    <style>
      #oopss {
        background: linear-gradient(-45deg, #000000, #cfcfcb);
        position: fixed;
        left: 0px;
        top: 0;
        width: 100%;
  ...
  <body>
    <div id="oopss">
      <div id="error-text">
        ...
        />
        <span
          ><label style="color: rgb(255, 79, 79)">404</label> PAGE NOT
          FOUND</span
        >
      </div>
    </div>
